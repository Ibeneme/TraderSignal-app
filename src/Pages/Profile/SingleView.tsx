            ...
            {subDetailsJoin?.map((message, index) => (
              <View
                ...
                style={{
                  maxWidth: 300,
                  backgroundColor:
                    message?.admin === post?.author
                      ? '#ffaa0021'
                      : message?.admin === user?.user?._id
                      ? '#ffffff'
                      : '#ffffff15',
                  padding: 12,
                  borderRadius: 12,
            ...
            {messages?.map((message, index) => (
              <View
                ...
                style={{
                  maxWidth: 300,
                  backgroundColor:
                    message?.admin === post?.author ? '#ffaa0025' : '#ffffff25',
                  padding: 12,
                  borderRadius: 12,
                  marginBottom: 6,
                  alignSelf:
                ...
                <Text
                  ...
                  {message?.admin === post?.author ? 'Admin' : '**********'}
                ...
                <Text
                  style={{
                    fontFamily: 'Plus Jakarta Sans SemiBold',
                    color: message?.admin === post?.author ? '#ffaa00' : '#Fff',
                    fontSize: 12,
                  }}>
                  {message?.msg}
                </Text>
